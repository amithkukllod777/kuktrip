...
const login: TranslationStrings = {
  ...
  'login.createAdminHint': '为 Kuk Trip 设置第一个管理员账户。',
  ...
  'login.insecureCookie.body':
    '你正在通过普通 HTTP 连接，浏览器会丢弃 Kuk Trip 的安全会话 Cookie，导致下一次请求报错“Access token required”。修复方式：改用 HTTPS；如果是家庭实验室环境，可设置 COOKIE_SECURE=false。',
