...
const oauth: TranslationStrings = {
  ...
  'oauth.authorize.loginDescription': '{client} 想要访问你的 Kuk Trip 账户，请先登录。',
  'oauth.authorize.loginButton': '登录 Kuk Trip',
  'oauth.authorize.requestLabel': '授权请求',
  'oauth.authorize.requestDescription': '此应用正在请求访问你的 Kuk Trip 账户。',
