...
const login: TranslationStrings = {
  ...
  'login.createAdminHint': 'Configurez le premier compte administrateur pour Kuk Trip.',
  ...
  'login.insecureCookie.body':
    'You’re connecting over plain HTTP, so your browser drops Kuk Trip’s secure session cookie — the next request fails with "Access token required". Fix: use HTTPS, or for a home-lab set COOKIE_SECURE=false.',
