...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Compagnons de voyage pour Kuk Trip',
  'settings.about.supporters.subtitle':
    "Pendant que tu planifies ton prochain itinéraire, ces personnes aident à planifier l'avenir de Kuk Trip. Leur contribution mensuelle va directement au développement et aux heures réellement passées — pour que Kuk Trip reste Open Source.",
  ...
  'settings.about.description':
    'Kuk Trip est un planificateur de voyage auto-hébergé qui vous aide à organiser vos voyages de la première idée au dernier souvenir. Planification journalière, budget, listes de bagages, photos et bien plus — le tout au même endroit, sur votre propre serveur.',
  ...
  'settings.airtrail.writeBackHint':
    'Désactivé par défaut : AirTrail fait référence et Kuk Trip se contente de le lire. Activez pour renvoyer vers AirTrail les modifications faites dans Kuk Trip.',
