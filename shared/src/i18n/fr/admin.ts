...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Nécessite Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    "« Vérifié » signifie qu'un mainteneur de Kuk Trip a analysé ce plugin à la recherche de logiciels malveillants à chaque version — non pour sa qualité ni son bon fonctionnement. Ce n'est pas une garantie qu'un plugin est inoffensif.",
  ...
  'admin.plugins.security.reviewedBody':
    "Un plugin vérifié a été analysé manuellement à la recherche de logiciels malveillants par un mainteneur de Kuk Trip à chaque version — contrôlé pour du code hostile, non pour son bon fonctionnement. Ce n'est pas une promesse que le plugin est inoffensif.",
  'admin.plugins.security.trustTitle': 'En résumé',
  'admin.plugins.security.trustBody':
    "Installer un plugin revient à installer n'importe quelle application tierce : n'ajoutez que du code provenant d'auteurs de confiance et, en cas de doute, inspectez-le vous-même au préalable. Kuk Trip décline toute responsabilité concernant les plugins tiers.",
  ...
  'admin.addons.subtitle': 'Activez ou désactivez des fonctionnalités pour personnaliser votre expérience Kuk Trip.',
  ...
  'admin.weather.description':
    'Kuk Trip utilise Open-Meteo comme source de données météo. Open-Meteo est un service météo gratuit et open source — aucune clé API requise.',
  ...
  'admin.github.support': 'Aidez à poursuivre le développement de Kuk Trip',
  'admin.github.error': 'Impossible de charger les versions',
  'admin.github.by': 'par',
  'admin.update.available': 'Mise à jour disponible',
  'admin.update.text': 'Kuk Trip {version} est disponible. Vous utilisez {current}.',
  ...
  'admin.update.confirmText':
    'Kuk Trip sera mis à jour de {current} vers {version}. Le serveur redémarrera automatiquement ensuite.',
  ...
  'admin.update.dockerText':
    'Votre instance Kuk Trip fonctionne dans Docker. Pour mettre à jour vers {version}, exécutez les commandes suivantes sur votre serveur :',
  'admin.update.nonDockerText':
    "Cette instance Kuk Trip ne fonctionne pas dans Docker. Pour mettre à jour vers {version}, relancez la méthode d'installation ou de mise à jour que vous avez utilisée — par exemple, sur Proxmox Community Scripts, lancez la mise à jour depuis la console LXC :",
