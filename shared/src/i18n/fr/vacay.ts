...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': "Partagez votre plan de vacances avec d'autres utilisateurs Kuk Trip",
  'vacay.owner': 'Propriétaire',
  'vacay.shareEmailPlaceholder': "E-mail de l'utilisateur Kuk Trip",
  ...
  'vacay.inviteHint': 'Invitez un autre utilisateur Kuk Trip à partager un calendrier de vacances combiné.',
