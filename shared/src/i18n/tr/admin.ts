...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Kuk Trip {version}+ gerektirir',
  ...
  'admin.plugins.reviewedMeaning':
    '„İncelendi", bir Kuk Trip sorumlusunun bu eklentiyi her sürümde kötü amaçlı yazılıma karşı taradığı anlamına gelir — kalite ya da çalışıp çalışmadığı için değil. Bir eklentinin zararsız olduğunun garantisi değildir.',
  ...
  'admin.plugins.security.reviewedBody':
    'İncelenmiş bir eklenti, her sürümde bir Kuk Trip sorumlusu tarafından kötü amaçlı yazılıma karşı elle taranmıştır — düşmanca koda karşı kontrol edilmiştir, iyi çalışıp çalışmadığına göre değil. Bu, eklentinin zararsız olduğunun bir garantisi değildir.',
  'admin.plugins.security.trustTitle': 'Özetle',
  'admin.plugins.security.trustBody':
    'Bir eklenti yüklemek, herhangi bir üçüncü taraf uygulamasını yüklemek gibidir: yalnızca güvendiğiniz geliştiricilerin kodunu ekleyin ve şüpheye düştüğünüzde önce kendiniz inceleyin. Kuk Trip, üçüncü taraf eklentiler için hiçbir sorumluluk kabul etmez.',
  ...
  'admin.addons.subtitle': 'Kuk Trip deneyiminizi özelleştirmek için özellikleri etkinleştirin veya devre dışı bırakın.',
  ...
  'admin.weather.description':
    "Kuk Trip, hava durumu veri kaynağı olarak Open-Meteo'yu kullanıyor. Open-Meteo ücretsiz, açık kaynaklı bir hava durumu hizmetidir; API anahtarı gerekmez.",
  ...
  'admin.github.by': 'ile',
  'admin.github.support': "Kuk Trip'i geliştirmeye devam etmeme yardımcı oluyor",
  'admin.update.available': 'Güncelleme mevcut',
  'admin.update.text': 'Kuk Trip {versiyon} mevcut. {current} çalıştırıyorsunuz.',
  ...
  'admin.update.confirmText':
    'Kuk Trip, {current} sürümünden {version} sürümüne güncellenecek. Sunucu daha sonra otomatik olarak yeniden başlatılacaktır.',
  ...
  'admin.update.dockerText':
    "Kuk Trip örneğiniz Docker'da çalışır. {version} sürümüne güncellemek için sunucunuzda aşağıdaki komutları çalıştırın:",
  'admin.update.nonDockerText':
    'Bu Kuk Trip örneği Docker üzerinde çalışmıyor. {version} sürümüne güncellemek için kullandığınız kurulum veya güncelleme yöntemini yeniden çalıştırın — örneğin Proxmox Community Scripts kullanıyorsanız güncellemeyi LXC konsolundan çalıştırın:',
