...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Tatil planınızı diğer Kuk Trip kullanıcılarıyla paylaşın',
  'vacay.owner': 'Mal sahibi',
  'vacay.shareEmailPlaceholder': 'Kuk Trip kullanıcısının e-postası',
  ...
  'vacay.inviteHint': 'Başka bir Kuk Trip kullanıcısını birleşik bir tatil takvimini paylaşmaya davet edin.',
