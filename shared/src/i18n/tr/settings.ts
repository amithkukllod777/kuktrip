...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Kuk Trip için seyahat Arkadaşları',
  'settings.about.supporters.subtitle':
    "While you're planning your next route, these folks are helping plan Kuk Trip's future. Their monthly contribution goes straight into development and real hours spent — so Kuk Trip stays Open Source.",
  ...
  'settings.about.description':
    'Kuk Trip, seyahatlerinizi ilk fikirden son anıya kadar organize etmenize yardımcı olan, kendi kendine barındırılan bir seyahat planlayıcıdır. Gün planlaması, bütçe, paketleme listeleri, fotoğraflar ve çok daha fazlası; hepsi tek bir yerde, kendi sunucunuzda.',
  ...
  'settings.airtrail.writeBackHint':
    'Varsayılan olarak kapalı: AirTrail asıl kaynaktır ve Kuk Trip yalnızca okur. Kuk Trip’te yapılan değişiklikleri AirTrail’e geri göndermek için açın.',
