...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Travel companions for Kuk Trip',
  ...
  'settings.airtrail.writeBackHint':
    'Off by default: AirTrail is the source of truth and Kuk Trip only reads from it. Turn on to push edits made in Kuk Trip back to AirTrail.',
