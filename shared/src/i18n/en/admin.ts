...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Requires Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Reviewed" means a Kuk Trip maintainer scanned this plugin for malware on each version — not for quality or whether it works. It is not a guarantee that a plugin is harmless.',
  ...
  'admin.plugins.security.reviewedBody':
    'A reviewed plugin was manually scanned for malware by a Kuk Trip maintainer on each version — checked for hostile code, not for whether it works well. It is not a promise that the plugin is harmless.',
  'admin.plugins.security.trustTitle': 'The bottom line',
  'admin.plugins.security.trustBody':
    'Installing a plugin is like installing any third-party app: only add code from authors you trust, and when in doubt, inspect it yourself first. Kuk Trip takes no responsibility for third-party plugins.',
  ...
  'admin.addons.subtitle': 'Enable or disable features to customize your Kuk Trip experience.',
  ...
  'admin.weather.description':
    'Kuk Trip uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.',
  ...
  'admin.github.by': 'by',
  'admin.github.support': 'Helps me keep building Kuk Trip',
  'admin.update.available': 'Update available',
  'admin.update.text': 'Kuk Trip {version} is available. You are running {current}.',
  'admin.update.button': 'View on GitHub',
  'admin.update.install': 'Install Update',
  'admin.update.confirmTitle': 'Install Update?',
  'admin.update.confirmText':
    'Kuk Trip will be updated from {current} to {version}. The server will restart automatically afterwards.',
  ...
  'admin.update.dockerText':
    'Your Kuk Trip instance runs in Docker. To update to {version}, run the following commands on your server:',
  'admin.update.nonDockerText':
    'This Kuk Trip instance is not running in Docker. To update to {version}, re-run the install or update method you used — for example, on Proxmox Community Scripts run the update from the LXC console:',
