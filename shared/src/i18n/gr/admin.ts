...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Απαιτεί Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    'Το "Ελεγμένο" σημαίνει ότι ένας συντηρητής του Kuk Trip σάρωσε αυτό το plugin για κακόβουλο λογισμικό σε κάθε έκδοση — όχι για την ποιότητα ή για το αν λειτουργεί. Δεν αποτελεί εγγύηση ότι ένα plugin είναι ακίνδυνο.',
  ...
  'admin.plugins.security.reviewedBody':
    'Ένα ελεγμένο plugin σαρώθηκε χειροκίνητα για κακόβουλο λογισμικό από έναν συντηρητή του Kuk Trip σε κάθε έκδοση — ελέγχθηκε για εχθρικό κώδικα, όχι για το αν λειτουργεί καλά. Δεν αποτελεί υπόσχεση ότι το plugin είναι ακίνδυνο.',
  'admin.plugins.security.trustTitle': 'Το συμπέρασμα',
  'admin.plugins.security.trustBody':
    'Η εγκατάσταση ενός plugin είναι σαν την εγκατάσταση οποιασδήποτε εφαρμογής τρίτου: προσθέστε κώδικα μόνο από δημιουργούς που εμπιστεύεστε, και σε περίπτωση αμφιβολίας, ελέγξτε τον πρώτα μόνοι σας. Το Kuk Trip δεν αναλαμβάνει καμία ευθύνη για plugins τρίτων.',
  ...
  'admin.addons.subtitle':
    'Ενεργοποιήστε ή απενεργοποιήστε λειτουργίες για να εξατομικεύσετε την εμπειρία σας στο Kuk Trip.',
  ...
  'admin.weather.description':
    'Το Kuk Trip χρησιμοποιεί το Open-Meteo ως πηγή δεδομένων καιρού. Το Open-Meteo είναι μια δωρεάν, ανοιχτού κώδικα υπηρεσία καιρού — δεν απαιτείται κλειδί API.',
  ...
  'admin.github.by': 'από',
  'admin.github.support': 'Βοηθά να συνεχίσω την ανάπτυξη του Kuk Trip',
  'admin.update.available': 'Διαθέσιμη ενημέρωση',
  'admin.update.text': 'Το Kuk Trip {version} είναι διαθέσιμο. Εκτελείτε το {current}.',
  ...
  'admin.update.confirmText':
    'Το Kuk Trip θα ενημερωθεί από {current} σε {version}. Ο server θα επανεκκινήσει αυτόματα στη συνέχεια.',
  ...
  'admin.update.dockerText':
    'Η εγκατάστασή σας Kuk Trip εκτελείται σε Docker. Για να ενημερωθείτε στο {version}, εκτελέστε τις ακόλουθες εντολές στον server σας:',
  'admin.update.nonDockerText':
    'Αυτή η εγκατάσταση Kuk Trip δεν εκτελείται σε Docker. Για να ενημερωθείτε στο {version}, εκτελέστε ξανά τη μέθοδο εγκατάστασης ή ενημέρωσης που χρησιμοποιήσατε — για παράδειγμα, στα Proxmox Community Scripts εκτελέστε την ενημέρωση από την κονσόλα LXC:',
