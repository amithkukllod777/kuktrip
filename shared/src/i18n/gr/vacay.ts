...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Μοιραστείτε το πλάνο διακοπών σας με άλλους χρήστες Kuk Trip',
  'vacay.owner': 'Κάτοχος',
  'vacay.shareEmailPlaceholder': 'Email χρήστη Kuk Trip',
  ...
  'vacay.inviteHint': 'Προσκαλέστε έναν άλλο χρήστη Kuk Trip για να μοιραστείτε ένα κοινό ημερολόγιο διακοπών.',
