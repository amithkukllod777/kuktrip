...
const trip: TranslationStrings = {
  ...
  'trip.invite.linkHint':
    'Όποιος έχει λογαριασμό Kuk Trip και ανοίξει αυτόν τον σύνδεσμο, εντάσσεται στο ταξίδι ως μέλος. Δημιουργήστε ξανά τον σύνδεσμο για να ακυρώσετε τον παλιό.',
