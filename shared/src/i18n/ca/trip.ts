...
const trip: TranslationStrings = {
  ...
  'trip.invite.linkHint': 'Qualsevol persona amb un compte de TREK que obri aquest enllaç s\'unirà al viatge com a membre. Torna\'l a generar si vols invalidar l\'enllaç antic.',
