...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Requer Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Revisado" significa que um mantenedor do Kuk Trip verificou este plugin em busca de malware em cada versão — não quanto à qualidade ou se ele funciona. Não é garantia de que um plugin seja inofensivo.',
  ...
  'admin.plugins.security.reviewedBody':
    'Um plugin revisado foi verificado manualmente em busca de malware por um mantenedor do Kuk Trip em cada versão — checado quanto a código malicioso, não quanto a funcionar bem. Não é uma promessa de que o plugin seja inofensivo.',
  'admin.plugins.security.trustTitle': 'Em resumo',
  'admin.plugins.security.trustBody':
    'Instalar um plugin é como instalar qualquer app de terceiros: adicione apenas código de autores em quem você confia e, em caso de dúvida, inspecione-o você mesmo antes. O Kuk Trip não assume nenhuma responsabilidade por plugins de terceiros.',
  ...
  'admin.addons.subtitle': 'Ative ou desative recursos para personalizar sua experiência no Kuk Trip.',
  ...
  'admin.weather.description':
    'O Kuk Trip usa Open-Meteo como fonte de clima. Open-Meteo é um serviço gratuito e de código aberto — sem chave de API.',
  ...
  'admin.github.by': 'por',
  'admin.github.support': 'Ajuda a continuar desenvolvendo o Kuk Trip',
  'admin.update.available': 'Atualização disponível',
  'admin.update.text': 'O Kuk Trip {version} está disponível. Você está na {current}.',
  ...
  'admin.update.confirmText':
    'O Kuk Trip será atualizado de {current} para {version}. O servidor reiniciará automaticamente em seguida.',
  ...
  'admin.update.dockerText': 'Sua instância Kuk Trip roda no Docker. Para atualizar para {version}, execute no servidor:',
  'admin.update.nonDockerText':
    'Esta instância do Kuk Trip não está rodando no Docker. Para atualizar para {version}, execute novamente o método de instalação ou atualização que você usou — por exemplo, no Proxmox Community Scripts, execute a atualização a partir do console do LXC:',
