...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Companheiros de viagem do Kuk Trip',
  'settings.about.supporters.subtitle':
    'Enquanto você planeja sua próxima rota, essas pessoas planejam junto o futuro do Kuk Trip. A contribuição mensal delas vai direto para o desenvolvimento e horas reais investidas — para o Kuk Trip continuar Open Source.',
  ...
  'settings.about.description':
    'Kuk Trip é um planejador de viagens auto-hospedado que ajuda você a organizar suas viagens da primeira ideia à última lembrança. Planejamento diário, orçamento, listas de bagagem, fotos e muito mais — tudo em um só lugar, no seu próprio servidor.',
  ...
  'settings.airtrail.writeBackHint':
    'Desativado por padrão: o AirTrail é a fonte da verdade e o Kuk Trip apenas lê dele. Ative para enviar ao AirTrail as alterações feitas no Kuk Trip.',
