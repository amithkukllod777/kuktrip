...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Compartilhe seu plano de férias com outros usuários do Kuk Trip',
  'vacay.owner': 'Proprietário',
  'vacay.shareEmailPlaceholder': 'E-mail do usuário Kuk Trip',
  ...
  'vacay.inviteHint': 'Convide outro usuário Kuk Trip para compartilhar um calendário de férias combinado.',
