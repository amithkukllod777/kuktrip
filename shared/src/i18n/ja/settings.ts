...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Kuk Tripの旅仲間',
  'settings.about.supporters.subtitle': '皆さんの支援がKuk Tripの未来を支えています。',
  ...
  'settings.about.description': 'Kuk Tripはセルフホスト型の旅行プランナーです。',
  ...
  'settings.airtrail.writeBackHint':
    '既定ではオフ: AirTrail が信頼できる情報源で、Kuk Trip は読み取りのみを行います。Kuk Trip で行った編集を AirTrail に書き戻すにはオンにします。',
