...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Kuk Trip {version} 以上が必要',
  ...
  'admin.plugins.reviewedMeaning':
    '「レビュー済み」とは、Kuk Tripのメンテナーが各バージョンでこのプラグインをマルウェアの観点から確認したという意味です — 品質や動作の可否を確認したものではありません。プラグインが無害であることを保証するものではありません。',
  ...
  'admin.plugins.security.isolationBody':
    'プラグインは、自身のファイルしか読み取れない厳重に制限された独立プロセスとして実行されます。データベース、ログイン用のシークレット、暗号鍵を読み取ることはできず、他のプログラムを起動することも、どこかにファイルを書き込むこともできません。その画面は隔離されたブラウザフレーム内で動作し、セッションCookieを読み取ったり、周囲のKuk Tripページに干渉したりすることはできません。',
  'admin.plugins.security.permsTitle': '権限の意味',
  'admin.plugins.security.permsBody':
    'インストール前に表示される権限は、プラグインの実行中にKuk Tripが強制する厳格な制限です — リストにないことは一切実行できません。ただし、これらはプラグインが何をできるかを示すもので、実際に何をするかを示すものではありません。旅行の読み取りとサーバーへの接続を許可されたプラグインは、あなたの旅行をそのサーバーに送信できます。説明文だけでなく、権限と接続先ホストも確認してください。',
  'admin.plugins.security.limitsTitle': '保証できないこと',
  'admin.plugins.security.limitsBody':
    'この分離は強固なソフトウェア上の境界ですが、絶対的なものではありません。プラグインは、あなたが承認した権限のとおりに動作するため、その権限の範囲内では説明とは異なる振る舞いをする場合があり、正当に保持しているデータを宣言済みのホストへ送信することもできます。Kuk Tripは、プラグインのコードが実際に何をするかを読み取ったり判断したりはしません。',
  ...
  'admin.plugins.security.reviewedBody':
    'レビュー済みのプラグインは、Kuk Tripのメンテナーが各バージョンで手動でマルウェアの有無を確認したものです — 悪意のあるコードの有無を確認したものであり、正しく動作するかどうかを確認したものではありません。プラグインが無害であることを約束するものではありません。',
  'admin.plugins.security.trustTitle': '結論',
  'admin.plugins.security.trustBody':
    'プラグインのインストールは、サードパーティ製アプリのインストールと同じです。信頼できる作者のコードのみを追加し、少しでも疑わしい場合は、まずご自身で内容を確認してください。Kuk Tripはサードパーティ製プラグインについて一切の責任を負いません。',
  ...
  'admin.addons.subtitle': '機能を有効／無効にしてKuk Tripをカスタマイズします。',
  ...
  'admin.weather.description':
    'Kuk Tripは天気データにOpen‑Meteoを使用しています。無料でオープンソース、APIキーは不要です。',
  ...
  'admin.github.by': '作成者',
  'admin.github.support': 'Kuk Tripの開発を支援',
  'admin.update.available': '更新があります',
  'admin.update.text': 'Kuk Trip {version} が利用可能です。現在は {current} を使用しています。',
  'admin.update.button': 'GitHubで見る',
  'admin.update.install': '更新をインストール',
  'admin.update.confirmTitle': '更新をインストールしますか？',
  'admin.update.confirmText': 'Kuk Tripを {current} から {version} に更新します。更新後、サーバーは自動的に再起動します。',
  ...
  'admin.update.dockerText':
    'Kuk TripはDockerで実行されています。{version} に更新するには、サーバーで次のコマンドを実行してください：',
  'admin.update.nonDockerText':
    'このKuk TripインスタンスはDockerで実行されていません。{version} に更新するには、使用したインストールまたは更新方法をもう一度実行してください。たとえばProxmox Community Scriptsの場合は、LXCコンソールから更新を実行します：',
