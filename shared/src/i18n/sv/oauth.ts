...
const oauth: TranslationStrings = {
  ...
  'oauth.authorize.loginDescription': '{client} vill ha åtkomst till ditt Kuk Trip konto. Logga in först.',
  'oauth.authorize.loginButton': 'Logga in på Kuk Trip',
  'oauth.authorize.requestLabel': 'Begäran om behörighet',
  'oauth.authorize.requestDescription': 'Den här applikationen begär åtkomst till ditt Kuk Trip konto.',
