...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Kräver Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '”Granskad” betyder att en Kuk Trip-underhållare har skannat pluginet efter skadlig kod i varje version — inte efter kvalitet eller om det fungerar. Det är ingen garanti för att ett plugin är ofarligt.',
  ...
  'admin.plugins.security.reviewedBody':
    'Ett granskat plugin har manuellt skannats efter skadlig kod av en Kuk Trip-underhållare i varje version — kontrollerat för fientlig kod, inte för om det fungerar bra. Det är inget löfte om att pluginet är ofarligt.',
  'admin.plugins.security.trustTitle': 'Sammanfattningsvis',
  'admin.plugins.security.trustBody':
    'Att installera ett plugin är som att installera vilken tredjepartsapp som helst: lägg bara till kod från upphovspersoner du litar på, och granska det själv först om du är osäker. Kuk Trip tar inget ansvar för tredjepartsplugins.',
  ...
  'admin.addons.subtitle': 'Aktivera eller inaktivera funktioner för att anpassa din Kuk Trip-upplevelse.',
  ...
  'admin.weather.description':
    'Kuk Trip använder Open-Meteo som källa för väderdata. Open-Meteo är en kostnadsfri vädertjänst med öppen källkod – ingen API-nyckel krävs.',
  ...
  'admin.github.by': 'av',
  'admin.github.support': 'Hjälper mig att fortsätta bygga Kuk Trip',
  'admin.update.available': 'Uppdatering tillgänglig',
  'admin.update.text': 'Kuk Trip {version} finns tillgängligt. Du kör {current}.',
  ...
  'admin.update.confirmText':
    'Kuk Trip kommer att uppdateras från {current} till {version}. Servern startas om automatiskt därefter.',
  ...
  'admin.update.dockerText':
    'Din Kuk Trip-instans körs i Docker. För att uppdatera till {version} kör du följande kommandon på din server:',
  'admin.update.nonDockerText':
    'Denna Kuk Trip-instans körs inte i Docker. För att uppdatera till {version}, kör installations- eller uppdateringsmetod du använde på nytt — till exempel, i Proxmox Community Scripts kör du uppdateringen från LXC-konsolen:',
