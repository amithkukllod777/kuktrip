...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Resekompisar för Kuk Trip',
  'settings.about.supporters.subtitle':
    'Medan du planerar din nästa rutt bidrar dessa personer till att forma Kuk Trip:s framtid. Deras månatliga bidrag går direkt till utveckling och faktisk arbetstid – så att Kuk Trip förblir öppen källkod.',
  ...
  'settings.about.description':
    'Kuk Trip är en resplanerare som du själv kan driva och som hjälper dig att organisera dina resor från den första idén till det sista minnet. Dagsplanering, budget, packlistor, foton och mycket mer – allt på ett och samma ställe, på din egen server.',
  ...
  'settings.airtrail.writeBackHint':
    'Avstängt som standard: AirTrail är den primära källan och Kuk Trip läser endast från den. Aktivera funktionen för att skicka ändringar som gjorts i Kuk Trip tillbaka till AirTrail.',
