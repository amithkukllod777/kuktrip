...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Vereist Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Beoordeeld" betekent dat een Kuk Trip-beheerder deze plugin bij elke versie op malware heeft gecontroleerd — niet op kwaliteit of op de vraag of hij werkt. Het is geen garantie dat een plugin ongevaarlijk is.',
  ...
  'admin.plugins.security.reviewedBody':
    'Een beoordeelde plugin is bij elke versie handmatig door een Kuk Trip-beheerder op malware gecontroleerd — gecontroleerd op kwaadaardige code, niet op de vraag of hij goed werkt. Het is geen belofte dat de plugin ongevaarlijk is.',
  'admin.plugins.security.trustTitle': 'De conclusie',
  'admin.plugins.security.trustBody':
    'Een plugin installeren is als het installeren van elke andere app van derden: voeg alleen code toe van auteurs die je vertrouwt en controleer deze bij twijfel eerst zelf. Kuk Trip aanvaardt geen enkele verantwoordelijkheid voor plugins van derden.',
  ...
  'admin.addons.subtitle': 'Schakel functies in of uit om je Kuk Trip-ervaring aan te passen.',
  ...
  'admin.weather.description':
    'Kuk Trip gebruikt Open-Meteo als weerbron. Open-Meteo is een gratis, open-source weerdienst — geen API-sleutel vereist.',
  ...
  'admin.github.support': 'Helpt mij Kuk Trip verder te ontwikkelen',
  'admin.github.error': 'Releases laden mislukt',
  'admin.github.by': 'door',
  'admin.update.available': 'Update beschikbaar',
  'admin.update.text': 'Kuk Trip {version} is beschikbaar. Je draait {current}.',
  'admin.update.button': 'Bekijk op GitHub',
  'admin.update.install': 'Update installeren',
  'admin.update.confirmTitle': 'Update installeren?',
  'admin.update.confirmText': 'Kuk Trip wordt bijgewerkt van {current} naar {version}. De server herstart automatisch.',
  ...
  'admin.update.dockerText':
    "Je Kuk Trip-instantie draait in Docker. Om bij te werken naar {version}, voer de volgende commando's uit op je server:",
  'admin.update.nonDockerText':
    'Deze Kuk Trip-instantie draait niet in Docker. Om bij te werken naar {version}, voer de installatie- of updatemethode die je hebt gebruikt opnieuw uit — bij Proxmox Community Scripts voer je de update bijvoorbeeld uit vanuit de LXC-console:',
