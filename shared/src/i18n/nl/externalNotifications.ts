...
const nl: NotificationLocale = {
  email: {
    footer: 'Je ontvangt dit omdat je meldingen hebt ingeschakeld in Kuk Trip.',
    manage: 'Voorkeuren beheren',
    madeWith: 'Made with',
    openTrek: 'Kuk Trip openen',
  },
  events: {
    trip_invite: (p) => ({
    ...
    vacay_invite: (p) => ({
      ...
      body: `${p.actor} nodigt je uit om vakantieplannen te fuseren. Open Kuk Trip om te accepteren of af te wijzen.`,
    }),
    collection_invite: (p) => ({
      title: 'Collectie-uitnodiging',
      body: `${p.actor} nodigt je uit om een collectie te delen. Open Kuk Trip om te accepteren of af te wijzen.`,
    }),
    photos_shared: (p) => ({
    ...
    version_available: (p) => ({
      title: 'Nieuwe Kuk Trip-versie beschikbaar',
      body: `Kuk Trip ${p.version} is nu beschikbaar. Bezoek het beheerderspaneel om bij te werken.`,
    }),
  ...
  passwordReset: {
    ...
    greeting: 'Hallo',
    body: 'We hebben een verzoek ontvangen om het wachtwoord voor je Kuk Trip-account te resetten. Klik op de knop hieronder om een nieuw wachtwoord in te stellen.',
