...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Reisgezelschap voor Kuk Trip',
  'settings.about.supporters.subtitle':
    'Terwijl jij je volgende route plant, plannen deze mensen mee aan de toekomst van Kuk Trip. Hun maandelijkse bijdrage gaat rechtstreeks naar ontwikkeling en echte uren — zodat Kuk Trip Open Source blijft.',
  ...
  'settings.about.description':
    "Kuk Trip is een zelf-gehoste reisplanner die je helpt je reizen te organiseren van het eerste idee tot de laatste herinnering. Dagplanning, budget, paklijsten, foto's en nog veel meer — alles op één plek, op je eigen server.",
  ...
  'settings.airtrail.writeBackHint':
    'Standaard uit: AirTrail is de bron van waarheid en Kuk Trip leest er alleen uit. Schakel in om in Kuk Trip gemaakte wijzigingen terug te sturen naar AirTrail.',
