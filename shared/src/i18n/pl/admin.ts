...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Wymaga Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '„Zweryfikowana” oznacza, że opiekun Kuk Trip przeskanował tę wtyczkę pod kątem złośliwego oprogramowania w każdej wersji — nie pod kątem jakości ani tego, czy działa. To nie jest gwarancja, że wtyczka jest nieszkodliwa.',
  ...
  'admin.plugins.security.reviewedBody':
    'Zweryfikowana wtyczka została ręcznie przeskanowana pod kątem złośliwego oprogramowania przez opiekuna Kuk Trip w każdej wersji — sprawdzona pod kątem wrogiego kodu, a nie tego, czy działa dobrze. To nie jest obietnica, że wtyczka jest nieszkodliwa.',
  'admin.plugins.security.trustTitle': 'Podsumowanie',
  'admin.plugins.security.trustBody':
    'Instalacja wtyczki jest jak instalacja dowolnej aplikacji innych firm: dodawaj tylko kod od autorów, którym ufasz, a w razie wątpliwości najpierw samodzielnie go sprawdź. Kuk Trip nie ponosi żadnej odpowiedzialności za wtyczki innych firm.',
  ...
  'admin.addons.subtitle': 'Włączaj lub wyłączaj funkcje, aby dostosować swoje doświadczenie w Kuk Trip.',
  ...
  'admin.weather.description':
    'Kuk Trip korzysta z Open-Meteo jako źródła danych pogodowych. Open-Meteo to darmowy, otwartoźródłowy serwis pogodowy — klucz API nie jest wymagany.',
  ...
  'admin.github.support': 'Pomóż mi rozwijać Kuk Trip',
  'admin.update.available': 'Dostępna aktualizacja',
  'admin.update.text': 'Dostępna jest wersja Kuk Trip {version}. Używasz {current}.',
  ...
  'admin.update.confirmText':
    'Kuk Trip zostanie zaktualizowany z {current} do {version}. Serwer zostanie automatycznie zrestartowany po zakończeniu.',
  ...
  'admin.update.dockerText':
    'Twoja instancja Kuk Trip działa w Dockerze. Aby zaktualizować do {version}, uruchom następujące polecenia na swoim serwerze:',
  'admin.update.nonDockerText':
    'Ta instancja Kuk Trip nie działa w Dockerze. Aby zaktualizować do {version}, uruchom ponownie metodę instalacji lub aktualizacji, której użyłeś — na przykład w Proxmox Community Scripts uruchom aktualizację z konsoli LXC:',
