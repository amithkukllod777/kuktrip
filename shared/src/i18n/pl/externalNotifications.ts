...
const pl: NotificationLocale = {
  email: {
    footer: 'Otrzymałeś/aś tę wiadomość, ponieważ masz włączone powiadomienia w Kuk Trip.',
    manage: 'Zarządzaj preferencjami w ustawieniach',
    madeWith: 'Made with',
    openTrek: 'Otwórz Kuk Trip',
  },
  events: {
    trip_invite: (p) => ({
    ...
    vacay_invite: (p) => ({
      ...
      body: `${p.actor} zaprosił Cię do połączenia planów urlopowych. Otwórz Kuk Trip, aby zaakceptować lub odrzucić.`,
    }),
    collection_invite: (p) => ({
      title: 'Zaproszenie do kolekcji',
      body: `${p.actor} zaprosił Cię do udostępnienia kolekcji. Otwórz Kuk Trip, aby zaakceptować lub odrzucić.`,
    }),
    photos_shared: (p) => ({
    ...
    version_available: (p) => ({
      title: 'Nowa wersja Kuk Trip dostępna',
      body: `Kuk Trip ${p.version} jest teraz dostępny. Odwiedź panel administracyjny, aby zaktualizować.`,
    }),
  ...
  passwordReset: {
    ...
    greeting: 'Cześć',
    body: 'Otrzymaliśmy prośbę o zresetowanie hasła do Twojego konta Kuk Trip. Kliknij przycisk poniżej, aby ustawić nowe hasło.',
