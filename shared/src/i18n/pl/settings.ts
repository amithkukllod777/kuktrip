...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Towarzystwo podróży dla Kuk Trip',
  'settings.about.supporters.subtitle':
    'Gdy planujesz kolejną trasę, te osoby planują razem ze mną przyszłość Kuk Trip. Ich comiesięczny wkład idzie bezpośrednio na rozwój i realnie przepracowane godziny — aby Kuk Trip pozostał Open Source.',
  ...
  'settings.about.description':
    'Kuk Trip to samodzielnie hostowany planer podróży, który pomaga organizować wyprawy od pierwszego pomysłu po ostatnie wspomnienie. Planowanie dzienne, budżet, listy pakowania, zdjęcia i wiele więcej — wszystko w jednym miejscu, na własnym serwerze.',
  ...
  'settings.airtrail.writeBackHint':
    'Domyślnie wyłączone: AirTrail jest źródłem prawdy, a Kuk Trip tylko z niego odczytuje. Włącz, aby wysyłać zmiany wprowadzone w Kuk Trip z powrotem do AirTrail.',
