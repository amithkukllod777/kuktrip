...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Compagni di viaggio per Kuk Trip',
  'settings.about.supporters.subtitle':
    'Mentre pianifichi il tuo prossimo itinerario, queste persone aiutano a pianificare il futuro di Kuk Trip. Il loro contributo mensile va direttamente allo sviluppo e alle ore realmente investite — per mantenere Kuk Trip Open Source.',
  ...
  'settings.about.description':
    "Kuk Trip è un pianificatore di viaggi self-hosted che ti aiuta a organizzare i tuoi viaggi dalla prima idea all'ultimo ricordo. Pianificazione giornaliera, budget, liste bagagli, foto e molto altro — tutto in un unico posto, sul tuo server.",
  ...
  'settings.airtrail.writeBackHint':
    'Disattivato per impostazione predefinita: AirTrail è la fonte attendibile e Kuk Trip si limita a leggerlo. Attiva per inviare ad AirTrail le modifiche fatte in Kuk Trip.',
