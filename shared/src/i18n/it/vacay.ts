...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Condividi il tuo piano ferie con altri utenti Kuk Trip',
  'vacay.owner': 'Proprietario',
  'vacay.shareEmailPlaceholder': "Email dell'utente Kuk Trip",
  ...
  'vacay.inviteHint': 'Invita un altro utente Kuk Trip a condividere un calendario ferie combinato.',
