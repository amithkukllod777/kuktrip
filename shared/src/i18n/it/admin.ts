...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Richiede Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Verificato" significa che un manutentore di Kuk Trip ha esaminato questo plugin alla ricerca di malware a ogni versione — non ne ha valutato la qualità né il funzionamento. Non è una garanzia che il plugin sia innocuo.',
  ...
  'admin.plugins.security.reviewedBody':
    'Un plugin verificato è stato esaminato manualmente alla ricerca di malware da un manutentore di Kuk Trip a ogni versione — controllato per individuare codice ostile, non per valutare se funziona bene. Non è una promessa che il plugin sia innocuo.',
  'admin.plugins.security.trustTitle': 'In conclusione',
  'admin.plugins.security.trustBody':
    'Installare un plugin è come installare una qualsiasi app di terze parti: aggiungi solo codice di autori di cui ti fidi e, in caso di dubbio, ispezionalo personalmente prima. Kuk Trip non si assume alcuna responsabilità per i plugin di terze parti.',
  ...
  'admin.addons.subtitle': 'Abilita o disabilita le funzionalità per personalizzare la tua esperienza Kuk Trip.',
  ...
  'admin.weather.description':
    'Kuk Trip utilizza Open-Meteo come fonte dei dati meteo. Open-Meteo è un servizio meteo gratuito e open-source — non è richiesta alcuna chiave API.',
  ...
  'admin.github.by': 'da',
  'admin.github.support': 'Mi aiuta a continuare a sviluppare Kuk Trip',
  'admin.update.available': 'Aggiornamento disponibile',
  'admin.update.text': 'Kuk Trip {version} è disponibile. Stai eseguendo {current}.',
  ...
  'admin.update.confirmText':
    'Kuk Trip verrà aggiornato da {current} a {version}. Il server si riavvierà automaticamente in seguito.',
  ...
  'admin.update.dockerText':
    'La tua istanza Kuk Trip è in esecuzione in Docker. Per aggiornare alla versione {version}, esegui i seguenti comandi sul tuo server:',
  'admin.update.nonDockerText':
    "Questa istanza Kuk Trip non è in esecuzione in Docker. Per aggiornare alla versione {version}, riesegui il metodo di installazione o aggiornamento che hai usato — ad esempio, su Proxmox Community Scripts esegui l'aggiornamento dalla console LXC:",
