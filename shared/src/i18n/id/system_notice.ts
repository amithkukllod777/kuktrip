...
const system_notice: TranslationStrings = {
  'system_notice.welcome_v1.title': 'Selamat datang di Kuk Trip',
  ...
  'system_notice.welcome_v1.hero_alt': 'Destinasi wisata indah dengan antarmuka Kuk Trip',
  ...
  'system_notice.thank_you_support.title': 'Terima kasih telah memakai Kuk Trip',
  'system_notice.thank_you_support.body':
    'Sekadar ucapan terima kasih singkat karena telah memasang Kuk Trip — ini benar-benar berarti banyak bagi saya.\n\nSaya seorang developer solo dan membangun Kuk Trip di waktu luang. Awalnya hanya alat kecil untuk perjalanan saya sendiri, dan sejujurnya saya terharu dengan dukungan serta minat dari komunitas sejak saat itu. Kuk Trip dibuat dengan sepenuh hati dari saya — tetapi juga berkat banyak kontributor eksternal hebat yang telah membantu membentuknya.\n\n**Kuk Trip bersifat open source dan sepenuhnya gratis — dan akan selalu begitu, selamanya. Tanpa paket berbayar, tanpa langganan, tanpa syarat tersembunyi. Saya janji.**\n\nJika Kuk Trip bermanfaat bagimu dan kamu ingin mendukung pengembangannya, secangkir kopi kecil sungguh membantu saya untuk terus membangun — sama sekali tanpa paksaan, tapi setiap cangkir membuat malam-malam panjang ini tetap berjalan.\n\nTerima kasih telah berada di sini.\n\n— Maurice',
  ...
  'system_notice.v3_photos.body':
    '**Foto** di Perencana Perjalanan telah dihapus. Foto Anda aman — Kuk Trip tidak pernah mengubah perpustakaan Immich atau Synology Anda.\n\nFoto kini ada di addon **Journey**. Journey bersifat opsional — jika belum tersedia, minta admin untuk mengaktifkannya di Admin → Addon.',
