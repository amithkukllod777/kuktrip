...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Rekan perjalanan untuk Kuk Trip',
  'settings.about.supporters.subtitle':
    'Saat kamu merencanakan rute berikutnya, orang-orang ini ikut merencanakan masa depan Kuk Trip. Kontribusi bulanan mereka langsung masuk ke pengembangan dan jam kerja nyata — supaya Kuk Trip tetap Open Source.',
  ...
  'settings.about.description':
    'Kuk Trip adalah perencana perjalanan self-hosted yang membantu kamu mengatur perjalanan dari ide pertama hingga kenangan terakhir. Perencanaan harian, anggaran, daftar bawaan, foto dan masih banyak lagi — semua di satu tempat, di servermu sendiri.',
  ...
  'settings.airtrail.writeBackHint':
    'Nonaktif secara bawaan: AirTrail adalah sumber kebenaran dan Kuk Trip hanya membaca darinya. Aktifkan untuk mengirim perubahan yang dibuat di Kuk Trip kembali ke AirTrail.',
