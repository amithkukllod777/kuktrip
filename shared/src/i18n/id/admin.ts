...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Memerlukan Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Ditinjau" berarti seorang maintainer Kuk Trip memindai plugin ini dari malware pada setiap versi — bukan untuk kualitas atau apakah plugin ini berfungsi. Ini bukan jaminan bahwa sebuah plugin tidak berbahaya.',
  ...
  'admin.plugins.security.reviewedBody':
    'Plugin yang ditinjau telah dipindai secara manual dari malware oleh seorang maintainer Kuk Trip pada setiap versi — diperiksa untuk kode berbahaya, bukan untuk apakah plugin berfungsi dengan baik. Ini bukan janji bahwa plugin tidak berbahaya.',
  'admin.plugins.security.trustTitle': 'Intinya',
  'admin.plugins.security.trustBody':
    'Memasang plugin sama seperti memasang aplikasi pihak ketiga mana pun: hanya tambahkan kode dari pembuat yang kamu percaya, dan jika ragu, periksa sendiri terlebih dahulu. Kuk Trip tidak bertanggung jawab atas plugin pihak ketiga.',
  ...
  'admin.addons.subtitle': 'Aktifkan atau nonaktifkan fitur untuk menyesuaikan pengalaman Kuk Trip kamu.',
  ...
  'admin.weather.description':
    'Kuk Trip menggunakan Open-Meteo sebagai sumber data cuaca. Open-Meteo adalah layanan cuaca gratis dan open-source — tidak perlu kunci API.',
  ...
  'admin.github.support': 'Bantu saya terus mengembangkan Kuk Trip',
  'admin.update.available': 'Pembaruan tersedia',
  'admin.update.text': 'Kuk Trip {version} tersedia. Kamu menggunakan {current}.',
  'admin.update.button': 'Lihat di GitHub',
  'admin.update.install': 'Pasang Pembaruan',
  'admin.update.confirmTitle': 'Pasang Pembaruan?',
  'admin.update.confirmText':
    'Kuk Trip akan diperbarui dari {current} ke {version}. Server akan restart otomatis setelahnya.',
  ...
  'admin.update.dockerText':
    'Instans Kuk Trip kamu berjalan di Docker. Untuk memperbarui ke {version}, jalankan perintah berikut di servermu:',
  'admin.update.nonDockerText':
    'Instans Kuk Trip ini tidak berjalan di Docker. Untuk memperbarui ke {version}, jalankan ulang metode instalasi atau pembaruan yang kamu gunakan — misalnya, pada Proxmox Community Scripts jalankan pembaruan dari konsol LXC:',
