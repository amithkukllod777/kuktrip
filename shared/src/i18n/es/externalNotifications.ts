...
const es: NotificationLocale = {
  email: {
    footer: 'Recibiste esto porque tienes las notificaciones activadas en Kuk Trip.',
    manage: 'Gestionar preferencias',
    madeWith: 'Made with',
    openTrek: 'Abrir Kuk Trip',
  },
  events: {
    trip_invite: (p) => ({
    ...
    vacay_invite: (p) => ({
      ...
      body: `${p.actor} te invitó a fusionar planes de vacaciones. Abre Kuk Trip para aceptar o rechazar.`,
    }),
    collection_invite: (p) => ({
      title: 'Invitación a colección',
      body: `${p.actor} te invitó a compartir una colección. Abre Kuk Trip para aceptar o rechazar.`,
    }),
    photos_shared: (p) => ({
    ...
    version_available: (p) => ({
      title: 'Nueva versión de Kuk Trip disponible',
      body: `Kuk Trip ${p.version} ya está disponible. Visita el panel de administración para actualizar.`,
    }),
  ...
  passwordReset: {
    ...
    greeting: 'Hola',
    body: 'Recibimos una solicitud para restablecer la contraseña de tu cuenta de Kuk Trip. Haz clic en el botón de abajo para establecer una nueva contraseña.',
