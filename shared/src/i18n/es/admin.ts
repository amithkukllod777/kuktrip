...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Requiere Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Revisado" significa que un responsable de Kuk Trip analizó este plugin en busca de malware en cada versión, no su calidad ni si funciona. No es una garantía de que un plugin sea inofensivo.',
  ...
  'admin.plugins.security.reviewedBody':
    'Un plugin revisado fue analizado manualmente en busca de malware por un responsable de Kuk Trip en cada versión — se comprobó que no tuviera código malicioso, no si funciona bien. No es una promesa de que el plugin sea inofensivo.',
  'admin.plugins.security.trustTitle': 'En resumen',
  'admin.plugins.security.trustBody':
    'Instalar un plugin es como instalar cualquier aplicación de terceros: añade únicamente código de autores en los que confíes y, en caso de duda, inspecciónalo tú mismo primero. Kuk Trip no asume ninguna responsabilidad por los plugins de terceros.',
  ...
  'admin.addons.subtitle': 'Activa o desactiva funciones para personalizar tu experiencia en Kuk Trip.',
  ...
  'admin.weather.description':
    'Kuk Trip utiliza Open-Meteo como fuente de datos meteorológicos. Open-Meteo es un servicio meteorológico gratuito y de código abierto: no requiere clave API.',
  ...
  'admin.github.support': 'Ayuda a seguir desarrollando Kuk Trip',
  'admin.github.error': 'No se pudieron cargar las versiones',
  'admin.github.by': 'por',
  'admin.update.available': 'Actualización disponible',
  'admin.update.text': 'Kuk Trip {version} está disponible. Estás usando {current}.',
  ...
  'admin.update.confirmText':
    'Kuk Trip se actualizará de {current} a {version}. Después, el servidor se reiniciará automáticamente.',
  ...
  'admin.update.dockerText':
    'Tu instancia de Kuk Trip se ejecuta en Docker. Para actualizar a {version}, ejecuta los siguientes comandos en tu servidor:',
  'admin.update.nonDockerText':
    'Esta instancia de Kuk Trip no se ejecuta en Docker. Para actualizar a {version}, vuelve a ejecutar el método de instalación o actualización que utilizaste; por ejemplo, en Proxmox Community Scripts ejecuta la actualización desde la consola LXC:',
