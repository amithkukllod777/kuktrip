...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Reisebegleitung für Kuk Trip',
  'settings.about.supporters.subtitle':
    'Während du deine nächste Route planst, planen diese Leute mit, wie Kuk Trip weitergeht. Ihr monatlicher Beitrag fließt direkt in Entwicklung und echten Zeitaufwand — damit Kuk Trip Open Source bleibt.',
  ...
  'settings.about.description':
    'Kuk Trip ist ein selbst gehosteter Reiseplaner, der dir hilft, deine Trips von der ersten Idee bis zur letzten Erinnerung zu organisieren. Tagesplanung, Budget, Packlisten, Fotos und vieles mehr — alles an einem Ort, auf deinem eigenen Server.',
  ...
  'settings.airtrail.writeBackHint':
    'Standardmäßig aus: AirTrail ist die maßgebliche Quelle und Kuk Trip liest nur. Aktivieren, um in Kuk Trip vorgenommene Änderungen zurück an AirTrail zu senden.',
