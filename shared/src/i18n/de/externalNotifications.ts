...
const de: NotificationLocale = {
  email: {
    footer: 'Du erhältst diese E-Mail, weil du Benachrichtigungen in Kuk Trip aktiviert hast.',
    manage: 'Einstellungen verwalten',
    madeWith: 'Made with',
    openTrek: 'Kuk Trip öffnen',
  },
  events: {
    trip_invite: (p) => ({
    ...
    vacay_invite: (p) => ({
      ...
      body: `${p.actor} hat dich eingeladen, Urlaubspläne zu fusionieren. Öffne Kuk Trip um anzunehmen oder abzulehnen.`,
    }),
    collection_invite: (p) => ({
      title: 'Sammlungs-Einladung',
      body: `${p.actor} hat dich eingeladen, eine Sammlung zu teilen. Öffne Kuk Trip um anzunehmen oder abzulehnen.`,
    }),
    photos_shared: (p) => ({
    ...
    version_available: (p) => ({
      title: 'Neue Kuk Trip-Version verfügbar',
      body: `Kuk Trip ${p.version} ist jetzt verfügbar. Besuche das Admin-Panel zum Aktualisieren.`,
    }),
  ...
  passwordReset: {
    ...
    greeting: 'Hallo',
    body: 'Wir haben eine Anfrage erhalten, das Passwort für dein Kuk Trip-Konto zurückzusetzen. Klicke auf den Button unten, um ein neues Passwort festzulegen.',
