...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Benötigt Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '„Geprüft" heißt: Ein Kuk Trip-Maintainer hat den Code dieses Plugins bei jeder Version manuell auf Schadsoftware gescannt — nicht auf Qualität oder Funktion. Es ist keine Garantie, dass ein Plugin harmlos ist.',
  ...
  'admin.plugins.security.reviewedBody':
    'Ein geprüftes Plugin wurde bei jeder Version von einem Kuk Trip-Maintainer manuell auf Schadsoftware gescannt — geprüft auf feindlichen Code, nicht darauf, ob es gut funktioniert. Es ist kein Versprechen, dass das Plugin harmlos ist.',
  'admin.plugins.security.trustTitle': 'Das Fazit',
  'admin.plugins.security.trustBody':
    'Ein Plugin zu installieren ist wie jede fremde App zu installieren: Füge nur Code von Autoren hinzu, denen du vertraust, und prüfe ihn im Zweifel zuerst selbst. Kuk Trip übernimmt keine Verantwortung für Plugins von Drittanbietern.',
  ...
  'admin.addons.subtitle': 'Aktiviere oder deaktiviere Funktionen, um Kuk Trip nach deinen Wünschen anzupassen.',
  ...
  'admin.weather.description':
    'Kuk Trip nutzt Open-Meteo als Wetterdatenquelle. Open-Meteo ist ein kostenloser, quelloffener Wetterdienst — es wird kein API-Schlüssel benötigt.',
  ...
  'admin.github.by': 'von',
  'admin.github.support': 'Hilft mir, Kuk Trip weiterzuentwickeln',
  'admin.update.available': 'Update verfügbar',
  'admin.update.text': 'Kuk Trip {version} ist verfügbar. Du verwendest {current}.',
  ...
  'admin.update.confirmText':
    'Kuk Trip wird von {current} auf {version} aktualisiert. Der Server startet danach automatisch neu.',
  ...
  'admin.update.dockerText':
    'Deine Kuk Trip-Instanz läuft in Docker. Um auf {version} zu aktualisieren, führe folgende Befehle auf deinem Server aus:',
  'admin.update.nonDockerText':
    'Diese Kuk Trip-Instanz läuft nicht in Docker. Um auf {version} zu aktualisieren, führe die Installations- oder Update-Methode erneut aus, die du verwendet hast — bei Proxmox Community Scripts startest du das Update zum Beispiel über die LXC-Konsole:',
