...
const login: TranslationStrings = {
  ...
  'login.createAdminHint': 'Erstelle das erste Admin-Konto für Kuk Trip.',
  ...
  'login.insecureCookie.body':
    'Du verbindest dich über reines HTTP, daher verwirft dein Browser Kuk Trips sicheren Session-Cookie — die nächste Anfrage scheitert mit „Access token required". Lösung: HTTPS nutzen, oder für ein Heim-Setup COOKIE_SECURE=false setzen.',
