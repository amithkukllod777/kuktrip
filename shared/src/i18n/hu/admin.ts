...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Kuk Trip {version}+ szükséges',
  ...
  'admin.plugins.reviewedMeaning':
    'Az „Ellenőrizve" azt jelenti, hogy egy Kuk Trip karbantartó minden verziónál átvizsgálta ezt a plugint kártevők után — nem a minőségét vagy azt, hogy működik-e. Ez nem garancia arra, hogy a plugin ártalmatlan.',
  ...
  'admin.plugins.security.reviewedBody':
    'Egy ellenőrzött plugint egy Kuk Trip karbantartó minden verziónál kézzel átvizsgált kártevők után — ellenséges kód szempontjából ellenőrizte, nem pedig azt, hogy jól működik-e. Ez nem ígéret arra, hogy a plugin ártalmatlan.',
  'admin.plugins.security.trustTitle': 'A lényeg',
  'admin.plugins.security.trustBody':
    'Egy plugin telepítése olyan, mint bármely harmadik féltől származó alkalmazás telepítése: csak megbízható szerzőktől adj hozzá kódot, és kétség esetén előbb magad vizsgáld meg. A Kuk Trip semmilyen felelősséget nem vállal a harmadik féltől származó pluginokért.',
  ...
  'admin.addons.subtitle': 'Funkciók engedélyezése vagy letiltása a Kuk Trip testreszabásához.',
  ...
  'admin.weather.description':
    'A Kuk Trip az Open-Meteo-t használja időjárás-adatforrásként. Az Open-Meteo egy ingyenes, nyílt forráskódú időjárás-szolgáltatás — nincs szükség API kulcsra.',
  ...
  'admin.github.support': 'Segít fenntartani a Kuk Trip fejlesztését',
  'admin.update.available': 'Frissítés elérhető',
  'admin.update.text': 'A Kuk Trip {version} elérhető. Jelenleg a {current} verziót használod.',
  ...
  'admin.update.confirmText':
    'A Kuk Trip frissítésre kerül {current} verzióról {version} verzióra. A szerver ezután automatikusan újraindul.',
  ...
  'admin.update.dockerText':
    'A Kuk Trip példányod Dockerben fut. A {version} verzióra frissítéshez futtasd a következő parancsokat a szervereden:',
  'admin.update.nonDockerText':
    'Ez a Kuk Trip példány nem Dockerben fut. A {version} verzióra frissítéshez futtasd újra a telepítési vagy frissítési módszert, amelyet használtál — például Proxmox Community Scripts esetén futtasd a frissítést az LXC konzolból:',
