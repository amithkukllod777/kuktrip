...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Vyžaduje Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '„Zkontrolováno“ znamená, že správce Kuk Trip prověřil tento plugin na škodlivý kód u každé verze — nikoli jeho kvalitu ani to, zda funguje. Není to záruka, že je plugin neškodný.',
  ...
  'admin.plugins.security.reviewedBody':
    'Zkontrolovaný plugin ručně prověřil správce Kuk Trip na škodlivý kód u každé verze — kontroloval nepřátelský kód, nikoli to, zda dobře funguje. Není to slib, že je plugin neškodný.',
  'admin.plugins.security.trustTitle': 'Závěrem',
  'admin.plugins.security.trustBody':
    'Instalace pluginu je jako instalace jakékoli aplikace třetí strany: přidávejte pouze kód od autorů, kterým důvěřujete, a v případě pochybností si jej nejprve sami prohlédněte. Kuk Trip nenese žádnou odpovědnost za pluginy třetích stran.',
  ...
  'admin.addons.subtitle': 'Zapněte nebo vypněte funkce a přizpůsobte si Kuk Trip.',
  ...
  'admin.github.by': 'od',
  'admin.github.support': 'Pomáhá udržovat vývoj Kuk Trip',
  'admin.weather.title': 'Data o počasí',
  'admin.weather.badge': 'Od 24. března 2026',
  'admin.weather.description':
    'Kuk Trip používá Open-Meteo jako zdroj dat. Je to bezplatná open-source služba – není vyžadován API klíč.',
  ...
  'admin.update.text': 'Kuk Trip {version} je k dispozici. Aktuálně používáte verzi {current}.',
  ...
  'admin.update.confirmText':
    'Kuk Trip bude aktualizován z verze {current} na {version}. Server se poté automaticky restartuje.',
  ...
  'admin.update.dockerText':
    'Váš Kuk Trip běží v Dockeru. Pro aktualizaci na verzi {version} spusťte na svém serveru tyto příkazy:',
  'admin.update.nonDockerText':
    'Tato instance Kuk Trip neběží v Dockeru. Pro aktualizaci na verzi {version} znovu spusťte instalační nebo aktualizační metodu, kterou jste použili — například u Proxmox Community Scripts spusťte aktualizaci z konzole LXC:',
