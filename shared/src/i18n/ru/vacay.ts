...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поделитесь планом отпуска с другими пользователями Kuk Trip',
  'vacay.owner': 'Владелец',
  'vacay.shareEmailPlaceholder': 'Эл. почта пользователя Kuk Trip',
  ...
  'vacay.inviteHint': 'Пригласите другого пользователя Kuk Trip для совместного календаря отпусков.',
