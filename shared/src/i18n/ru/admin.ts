...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Требуется Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '«Проверен» означает, что сопровождающий Kuk Trip проверял этот плагин на вредоносный код в каждой версии — но не его качество или работоспособность. Это не гарантия того, что плагин безвреден.',
  ...
  'admin.plugins.security.reviewedBody':
    'Проверенный плагин был вручную просканирован на вредоносный код сопровождающим Kuk Trip в каждой версии — проверен на вредоносный код, а не на то, насколько хорошо он работает. Это не обещание того, что плагин безвреден.',
  'admin.plugins.security.trustTitle': 'Итог',
  'admin.plugins.security.trustBody':
    'Установка плагина похожа на установку любого стороннего приложения: добавляйте только код от авторов, которым доверяете, а при сомнениях сначала проверьте его самостоятельно. Kuk Trip не несёт ответственности за сторонние плагины.',
  ...
  'admin.addons.subtitle': 'Включайте или отключайте функции для настройки Kuk Trip под себя.',
  ...
  'admin.weather.description':
    'Kuk Trip использует Open-Meteo как источник данных о погоде. Open-Meteo — бесплатный сервис с открытым кодом, API-ключ не требуется.',
  ...
  'admin.github.support': 'Помогает продолжать разработку Kuk Trip',
  'admin.github.error': 'Не удалось загрузить релизы',
  'admin.github.by': 'от',
  'admin.update.available': 'Доступно обновление',
  'admin.update.text': 'Доступна версия Kuk Trip {version}. У вас установлена {current}.',
  ...
  'admin.update.confirmText': 'Kuk Trip будет обновлён с {current} до {version}. Сервер перезапустится автоматически.',
  ...
  'admin.update.dockerText':
    'Ваш экземпляр Kuk Trip работает в Docker. Для обновления до {version} выполните следующие команды на сервере:',
  'admin.update.nonDockerText':
    'Этот экземпляр Kuk Trip работает не в Docker. Чтобы обновиться до {version}, повторно запустите способ установки или обновления, который вы использовали, — например, в Proxmox Community Scripts выполните обновление из консоли LXC:',
