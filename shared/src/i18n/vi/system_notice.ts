...
const system_notice: TranslationStrings = {
  ...
  'system_notice.v3_thankyou.body':
    'Trước khi bạn đi - tôi muốn dành một chút thời gian.\n\nKuk Trip bắt đầu như một dự án phụ mà tôi xây dựng cho những chuyến đi của riêng mình. Tôi chưa bao giờ tưởng tượng nó sẽ phát triển thành thứ mà 4.000 người trong số các bạn hiện đang tin tưởng để lên kế hoạch cho chuyến phiêu lưu của mình. Mọi ngôi sao, mọi số báo, mọi yêu cầu về tính năng - tôi đọc tất cả và chúng khiến tôi phải thức khuya giữa công việc toàn thời gian và trường đại học.\n\nTôi muốn bạn biết: Kuk Trip sẽ luôn là nguồn mở, luôn tự lưu trữ, luôn là của bạn. Không theo dõi, không đăng ký, không ràng buộc. Chỉ là một công cụ được xây dựng bởi một người cũng yêu thích du lịch như bạn.\n\nĐặc biệt cảm ơn [jubnl](https://github.com/jubnl) - bạn đã trở thành một cộng tác viên đáng kinh ngạc. Rất nhiều điều tạo nên sự tuyệt vời của 3.0 đều mang dấu ấn của bạn. Cảm ơn bạn đã tin tưởng vào dự án này khi nó vẫn còn nhiều khó khăn.\n\nVà gửi tới từng người trong số các bạn đã phát hiện lỗi, dịch một chuỗi, chia sẻ Kuk Trip với bạn bè hoặc đơn giản sử dụng nó để lên kế hoạch cho chuyến đi — **cảm ơn**. Bạn là lý do điều này tồn tại.\n\nĐây là nhiều cuộc phiêu lưu cùng nhau.\n\n— Maurice\n\n---\n\n[Tham gia cộng đồng trên Discord](https://discord.gg/7Q6M6jDwzf)\n\nNếu Kuk Trip giúp chuyến du lịch của bạn trở nên thú vị hơn thì một [cà phê nhỏ](https://ko-fi.com/mauriceboe) luôn luôn bật đèn.',
  ...
  'system_notice.welcome_v1.title': 'Chào mừng đến với Kuk Trip',
  ...
  'system_notice.welcome_v1.hero_alt': 'Một điểm đến du lịch tuyệt đẹp với lớp phủ Kuk Trip quy hoạch UI',
  ...
  'system_notice.thank_you_support.title': 'Cảm ơn bạn đã sử dụng Kuk Trip',
  'system_notice.thank_you_support.body':
    'Xin gửi lời cảm ơn nhanh chóng đến bạn vì đã cài đặt Kuk Trip — nó thực sự có ý nghĩa rất lớn.\n\nTôi là nhà phát triển một mình và tôi xây dựng Kuk Trip trong thời gian rảnh rỗi. Nó bắt đầu như một công cụ nhỏ dành riêng cho những chuyến đi của tôi và tôi thực sự rất ngạc nhiên trước sự hỗ trợ và quan tâm từ cộng đồng kể từ đó. Kuk Trip được tạo ra bằng cả trái tim của tôi — nhưng cũng nhờ có nhiều cộng tác viên bên ngoài tuyệt vời đã giúp định hình nó.\n\n**Kuk Trip là mã nguồn mở và hoàn toàn miễn phí — và nó sẽ mãi mãi như vậy. Không có tầng trả phí, không đăng ký, không bắt được. Tôi hứa.**\n\nNếu Kuk Trip hữu ích cho bạn và bạn muốn hỗ trợ sự phát triển của nó, thì một tách cà phê nhỏ thực sự giúp tôi tiếp tục xây dựng — không có chút áp lực nào, nhưng mỗi tách cà phê sẽ giúp bạn tiếp tục những đêm khuya.\n\nCảm ơn bạn đã ở đây.\n\n— Maurice',
