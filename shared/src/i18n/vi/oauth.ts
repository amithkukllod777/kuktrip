...
const oauth: TranslationStrings = {
  ...
  'oauth.authorize.loginDescription': '{client} muốn truy cập vào tài khoản Kuk Trip của bạn. Vui lòng đăng nhập trước.',
  'oauth.authorize.loginButton': 'Đăng nhập vào Kuk Trip',
  'oauth.authorize.requestLabel': 'Yêu cầu ủy quyền',
  'oauth.authorize.requestDescription': 'Ứng dụng này đang yêu cầu quyền truy cập vào tài khoản Kuk Trip của bạn.',
