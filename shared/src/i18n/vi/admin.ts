...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Yêu cầu Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"Đã kiểm duyệt" nghĩa là một người bảo trì Kuk Trip đã quét plugin này để tìm mã độc trên mỗi phiên bản — không phải về chất lượng hay việc nó có hoạt động hay không. Đây không phải là bảo đảm rằng plugin vô hại.',
  ...
  'admin.plugins.security.reviewedBody':
    'Một plugin đã kiểm duyệt đã được người bảo trì Kuk Trip quét thủ công để tìm mã độc trên mỗi phiên bản — được kiểm tra về mã độc hại, chứ không phải về việc nó có hoạt động tốt hay không. Đây không phải là lời hứa rằng plugin vô hại.',
  'admin.plugins.security.trustTitle': 'Điểm mấu chốt',
  'admin.plugins.security.trustBody':
    'Cài đặt một plugin cũng giống như cài đặt bất kỳ ứng dụng bên thứ ba nào: chỉ cài đặt mã từ những tác giả bạn tin tưởng, và khi còn nghi ngờ, hãy tự kiểm tra nó trước. Kuk Trip không chịu trách nhiệm về các plugin của bên thứ ba.',
  ...
  'admin.addons.subtitle': 'Bật hoặc tắt các tính năng để tùy chỉnh trải nghiệm Kuk Trip của bạn.',
  ...
  'admin.weather.description':
    'Kuk Trip sử dụng Open-Meteo làm nguồn dữ liệu thời tiết. Open-Meteo là dịch vụ thời tiết nguồn mở, miễn phí — không yêu cầu khóa API.',
  ...
  'admin.github.by': 'qua',
  'admin.github.support': 'Giúp tôi tiếp tục xây dựng Kuk Trip',
  'admin.update.available': 'Đã có bản cập nhật',
  'admin.update.text': 'Kuk Trip {version} có sẵn. Bạn đang chạy {current}.',
  ...
  'admin.update.confirmText':
    'Kuk Trip sẽ được cập nhật từ {current} lên {version}. Máy chủ sẽ tự động khởi động lại sau đó.',
  ...
  'admin.update.dockerText':
    'Phiên bản Kuk Trip của bạn chạy trong Docker. Để cập nhật lên {version}, hãy chạy các lệnh sau trên máy chủ của bạn:',
  'admin.update.nonDockerText':
    'Phiên bản Kuk Trip này không chạy trong Docker. Để cập nhật lên {version}, hãy chạy lại phương pháp cài đặt hoặc cập nhật mà bạn đã sử dụng — ví dụ: trên Proxmox Community Script chạy bản cập nhật từ bảng điều khiển LXC:',
