...
const settings: TranslationStrings = {
  ...
  'settings.about.supporters.title': 'Bạn đồng hành cho Kuk Trip',
  'settings.about.supporters.subtitle':
    'Trong khi bạn đang lên kế hoạch cho lộ trình tiếp theo của mình, những người này đang giúp lập kế hoạch cho tương lai của Kuk Trip. Đóng góp hàng tháng của họ được đổ thẳng vào hoạt động phát triển và số giờ thực tế được sử dụng — vì vậy Kuk Trip vẫn là Nguồn mở.',
  ...
  'settings.about.description':
    'Kuk Trip là công cụ lập kế hoạch du lịch tự lưu trữ giúp bạn tổ chức các chuyến đi của mình từ ý tưởng đầu tiên đến kỷ niệm cuối cùng. Lập kế hoạch trong ngày, ngân sách, danh sách đóng gói, ảnh và nhiều nội dung khác — tất cả đều ở cùng một nơi, trên máy chủ của riêng bạn.',
  ...
  'settings.airtrail.writeBackHint':
    'Tắt theo mặc định: AirTrail là nguồn sự thật và Kuk Trip chỉ đọc từ đó. Bật để đẩy các chỉnh sửa được thực hiện trong Kuk Trip trở lại AirTrail.',
