...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'Потрібен Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '«Перевірено» означає, що супроводжувач Kuk Trip перевіряв цей плагін на наявність шкідливого коду в кожній версії — а не на якість чи працездатність. Це не гарантія того, що плагін безпечний.',
  ...
  'admin.plugins.security.reviewedBody':
    'Перевірений плагін вручну сканував супроводжувач Kuk Trip на наявність шкідливого коду в кожній версії — перевіряли на ворожий код, а не на те, чи добре він працює. Це не обіцянка, що плагін безпечний.',
  'admin.plugins.security.trustTitle': 'Підсумок',
  'admin.plugins.security.trustBody':
    'Встановлення плагіна — це те саме, що встановлення будь-якого стороннього застосунку: додавайте лише код від авторів, яким довіряєте, а в разі сумнівів спершу перевірте його самостійно. Kuk Trip не несе відповідальності за сторонні плагіни.',
  ...
  'admin.addons.subtitle': 'Увімкніть або вимкніть функції, щоб налаштувати Kuk Trip під себе.',
  ...
  'admin.weather.description':
    'Kuk Trip використовує Open-Meteo як джерело даних про погоду. Open-Meteo — безкоштовний сервіс з відкритим кодом, API-ключ не потрібен.',
  ...
  'admin.github.support': 'Допомагає продовжувати розробку Kuk Trip',
  'admin.github.error': 'Не вдалося завантажити релізи',
  'admin.github.by': 'від',
  'admin.update.available': 'Доступне оновлення',
  'admin.update.text': 'Доступна версія Kuk Trip {version}. У вас встановлено {current}.',
  ...
  'admin.update.confirmText': 'Kuk Trip буде оновлено з {current} до {version}. Сервер перезапуститься автоматично.',
  ...
  'admin.update.dockerText':
    'Ваш екземпляр Kuk Trip працює в Docker. Для оновлення до {version} виконайте ці команди на сервері:',
  'admin.update.nonDockerText':
    'Цей екземпляр Kuk Trip не працює в Docker. Щоб оновити до {version}, повторно запустіть метод встановлення або оновлення, який ви використовували, — наприклад, у Proxmox Community Scripts запустіть оновлення з консолі LXC:',
