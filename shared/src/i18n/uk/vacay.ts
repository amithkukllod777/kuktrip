...
const vacay: TranslationStrings = {
  ...
  'vacay.sharingHint': 'Поділіться планом відпустки з іншими користувачами Kuk Trip',
  'vacay.owner': 'Власник',
  'vacay.shareEmailPlaceholder': 'Ел. пошта користувача Kuk Trip',
  ...
  'vacay.inviteHint': 'Запросіть іншого користувача Kuk Trip для спільного календаря відпусток.',
