...
const admin: TranslationStrings = {
  ...
  'admin.plugins.requiresTrek': 'يتطلب Kuk Trip {version}+',
  ...
  'admin.plugins.reviewedMeaning':
    '"تمت مراجعتها" تعني أن أحد القائمين على Kuk Trip فحص هذه الإضافة بحثًا عن البرمجيات الخبيثة في كل إصدار — وليس من حيث الجودة أو ما إذا كانت تعمل. وهي ليست ضمانًا بأن الإضافة غير ضارة.',
  ...
  'admin.plugins.security.reviewedBody':
    'الإضافة التي تمت مراجعتها فُحصت يدويًا بحثًا عن البرمجيات الخبيثة بواسطة أحد القائمين على Kuk Trip في كل إصدار — جرى فحصها بحثًا عن شيفرة ضارة، لا لمعرفة ما إذا كانت تعمل جيدًا. وهي ليست وعدًا بأن الإضافة غير ضارة.',
  'admin.plugins.security.trustTitle': 'الخلاصة',
  'admin.plugins.security.trustBody':
    'تثبيت إضافة يشبه تثبيت أي تطبيق من جهة خارجية: لا تُضِف سوى شيفرة من مطورين تثق بهم، وعند الشك، افحصها بنفسك أولًا. لا يتحمل Kuk Trip أي مسؤولية عن إضافات الجهات الخارجية.',
  ...
  'admin.addons.subtitle': 'فعّل أو عطّل الميزات لتخصيص تجربة Kuk Trip.',
  ...
  'admin.weather.description':
    'يستخدم Kuk Trip خدمة Open-Meteo كمصدر لبيانات الطقس. وهي خدمة مجانية ومفتوحة المصدر ولا تتطلب مفتاح API.',
  ...
  'admin.github.support': 'يساعدني في تطوير Kuk Trip',
  'admin.update.available': 'يتوفر تحديث',
  'admin.update.text': 'Kuk Trip {version} متوفر. أنت تستخدم {current}.',
  'admin.update.button': 'عرض على GitHub',
  'admin.update.install': 'تثبيت التحديث',
  'admin.update.confirmTitle': 'تثبيت التحديث؟',
  'admin.update.confirmText': 'سيتم تحديث Kuk Trip من {current} إلى {version}. سيُعاد تشغيل الخادم تلقائيًا بعد ذلك.',
  ...
  'admin.update.dockerText': 'يعمل Kuk Trip الخاص بك في Docker. للتحديث إلى {version}، نفّذ الأوامر التالية على الخادم:',
  'admin.update.nonDockerText':
    'لا يعمل Kuk Trip هذا في Docker. للتحديث إلى {version}، أعد تشغيل طريقة التثبيت أو التحديث التي استخدمتها — على سبيل المثال، في Proxmox Community Scripts نفّذ التحديث من وحدة تحكم LXC:',
