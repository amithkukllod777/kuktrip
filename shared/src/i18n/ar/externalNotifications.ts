...
const ar: NotificationLocale = {
  email: {
    footer: 'تلقيت هذا لأنك قمت بتفعيل الإشعارات في Kuk Trip.',
    manage: 'إدارة التفضيلات',
    madeWith: 'Made with',
    openTrek: 'فتح Kuk Trip',
  },
  events: {
    trip_invite: (p) => ({
    ...
    vacay_invite: (p) => ({
      ...
      body: `${p.actor} يدعوك لدمج خطط الإجازة. افتح Kuk Trip للقبول أو الرفض.`,
    }),
    collection_invite: (p) => ({
      title: 'دعوة إلى مجموعة',
      body: `${p.actor} يدعوك لمشاركة مجموعة. افتح Kuk Trip للقبول أو الرفض.`,
    }),
    photos_shared: (p) => ({
    ...
    version_available: (p) => ({
      title: 'إصدار Kuk Trip جديد متاح',
      body: `Kuk Trip ${p.version} متاح الآن. تفضل بزيارة لوحة الإدارة للتحديث.`,
    }),
  ...
  passwordReset: {
    ...
    greeting: 'مرحبا',
    body: 'تلقينا طلبًا لإعادة تعيين كلمة المرور لحسابك في Kuk Trip. انقر على الزر أدناه لتعيين كلمة مرور جديدة.',
